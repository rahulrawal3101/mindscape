                ...
                <Grid container justifyContent="center" alignItems="center" style={{ minHeight: '100vh' }}>
                    ...
                    <Grid container sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', mt:'50px' }}>
                        ...
                        <Grid item lg={5} md={5} sm={11} xs={11} sx={{  mt: '30px', color: 'black', p: '20px', borderRadius: '10px' }} >
                            <Typography sx={{ fontSize: {lg:'45px', md:'45px', sm:'40px', xs:'35px'}, fontWeight: 'bold', fontFamily: 'sans-serif', textAlign: 'center', color: 'black' }}>The Dangers of Ignoring Mental Stamina</Typography>
...
In today’s fast-paced digital world, children’s ability to focus and think critically is often under threat. Ignoring these challenges can lead to long-term cognitive deficits and poor academic performance.
                    ...
                    <Grid container sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', flexWrap:{sm:'wrap-reverse',xs:'wrap-reverse' } }}>
                        ...
                        <Grid item lg={5} md={5} sm={11} xs={12} sx={{ mt: '30px', color: 'black', p: '20px', borderRadius: '10px', mt:{lg:'0px', md:'0px', sm:'10px', xs:'10px'} }} >
                            ...
                            <Typography sx={{ fontSize: { lg: '22px', md: '17px', sm: '15px', xs: '15px' }, fontWeight: 'bold', fontFamily:'cursive', textAlign: 'center', color: 'black', mt: '10px' }}>Our educational game is designed to combat digital distractions and enhance cognitive abilities through engaging and scientifically-proven activities.
                            </Typography>
